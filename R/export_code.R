...
generate_r_script <- function(project,
  ...
  add(sprintf("# RNAflow reproducible analysis script"),
      ...
      "# Template: DE calls reflect each saved contrast (design, covariates,",
      "# shrinkage). Downstream steps (enrichment, WGCNA) use default settings --",
      "# edit thresholds / collections / power to match what you ran.",
      "",
      "library(RNAflow)",
      "",
